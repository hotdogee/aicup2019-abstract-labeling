...
def embedding_postprocessor(
  ...
  Args:
    ...
    token_type_vocab_size: int. The vocabulary size of `token_type_ids`. 2
...
def attention_layer(
  ...
  """
    ...
    if len(from_shape) == 3:
        ...
        if (
            batch_size is None or from_seq_length is None or
    ...
    query_layer = transpose_for_scores(
        query_layer, batch_size, num_attention_heads, from_seq_length,
        size_per_head
    )
